...
|---|---|
| Propositions (défaut) | `lire` , `proposer`, `noter` — une proposition apparaît dans le volet Assistant du mini-cosmos, à accepter ou refuser |
...
Tests de logique et de synchronisation, sans navigateur : `npm test`.
