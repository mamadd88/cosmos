...
const CHAMPS = { objectif: '…', actuel: '…', entropie: '…', reponse: '…', sas: '…', sasUntil: 'AAAA-MM-JJ (fin du test)', alerte: '…', kill: '…', etapes: ['…'], poids: 'vital | important | normal' };
const DOC = {
  ...
  actions: {
    lire:     { corps: {}, resultat: 'agent, cosmos, etageDe (l’étage de chaque cosmos : ethos, logos ou pathos, dans cet ordre de chute), etages (le repère de chaque étage), titresDe (les titres qui séparent les terrains de chaque cosmos ; le champ « titre » d’un mini-cosmos dit sous lequel il est rangé), miniCosmos (objets complets), propositionsEnAttente, journalRecent' },
  ...
  patch: 'Seuls les champs listés sont acceptés ; « etapes » ajoute des étapes (les doublons sont ignorés), « poids » vaut vital, important ou normal (il ordonne le tableau et hiérarchise), les autres remplacent le texte.',
};
